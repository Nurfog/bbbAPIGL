...
Write-Host "- Endpoints Empresa disponibles:"
Write-Host "  Salas:"
Write-Host "    POST   /apiv2/emp/salas"
Write-Host "    DELETE /apiv2/emp/salas/{roomId}"
Write-Host "    GET    /apiv2/emp/salas/{idCursoAbierto}/status"
Write-Host "  Grabaciones:"
Write-Host "    GET    /apiv2/emp/grabaciones/{idCursoAbierto}"
Write-Host "  Sesiones:"
Write-Host "    POST   /apiv2/emp/reprogramar-sesion"
Write-Host "  Invitaciones (nuevo módulo):"
Write-Host "    POST   /apiv2/emp/invitaciones/{idCursoAbierto}     (crear)"
Write-Host "    PUT    /apiv2/emp/invitaciones/{id}                (modificar)"
Write-Host "    POST   /apiv2/emp/invitaciones/batch               (lote)"
Write-Host "  Cursos:"
Write-Host "    DELETE /apiv2/emp/cursos/{idCursoAbierto}"
Write-Host ""
Write-Host "- Endpoints Empresa anteriormente mostrados:"
Write-Host "  - POST /apiv2/emp/salas"
